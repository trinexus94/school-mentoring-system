  ...
  <body>
      ...
      <div class="container">
        ...
        <nav>
          ...
          <li ><a href="student.php">HOME</a></li>
            ...
            <li class="current"><a href="leclist.php">LISTS</a></li>
    ...
    <section  >
        <div >
                ...
                <h1 style = "text-align:center">what would you like to view?</h1>
                  <form method="post" action="leclist.php">
                  <div style = "text-align:center">
                  <select name="option">
                                <option value="lecturer">Available lecturers</option>
    ...
    <?php
            if (isset($_POST['options'])) {
                ...
                if($option ==='lecturer'){
                    $user_check_query1 = "SELECT lname, fname FROM lecturer WHERE mentorship='yes' ";
